...
var getAsyncCmd = _bluebird.Promise.promisify(_nodeCmd["default"].run, {
  multiArgs: true,
  context: _nodeCmd["default"]
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return getAsyncCmd('npm run db:migrate');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return getAsyncCmd('npm run db:clean');
...
var _default = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  var db;
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 4:
          _context3.t0 = _yargs.argv.migrate;
          _context3.next = _context3.t0 === 'migrate' ? 7 : _context3.t0 === 'clean_and_migrate' ? 10 : 15;
          break;
